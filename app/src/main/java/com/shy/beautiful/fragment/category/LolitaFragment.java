...
public class LolitaFragment extends Fragment {
    ...
    public static String Category = "萝莉";
    public int index = 0;
    SpUtils spUtils;
                ...
                retrofitHelper.getImages(map)
                        ...
                        .subscribe(new Subscriber<List<ImagesBean>>() {
                            ...
                            public void onNext(List<ImagesBean> bean) {
                                ...
                                spUtils.put(Constant.LOLITA, str);
    ...
    private void initData() {
        ...
        if (spUtils.getSharedPreference(Constant.LOLITA, ImagesBean.class) == null) {
            Map<String, String> map = new HashMap<>();
            //map.put("num","10");
            map.put("key", Category);
            map.put("start", "" + index);
            ...
            index+=50;
            String jsonList = (String) spUtils.getSharedPreference(Constant.LOLITA, String.class);
            Gson gson1 = new Gson();
