...
public class LegsFragment extends Fragment {
    ...
    public static String Category = "美腿";
    public int index = 0;
    SpUtils spUtils;
    ...
    private void initData() {
        ...
        if (spUtils.getSharedPreference(Constant.LEGS, ImagesBean.class) == null) {
            Map<String, String> map = new HashMap<>();
            //map.put("num","10");
            map.put("key", Category);
            map.put("start", "" + index);
            ...
            index+=50;
            String jsonList = (String) spUtils.getSharedPreference(Constant.LEGS, String.class);
            Gson gson1 = new Gson();
