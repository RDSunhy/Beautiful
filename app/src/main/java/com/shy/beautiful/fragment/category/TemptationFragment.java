...
public class TemptationFragment extends Fragment {
    ...
    public static String Category = "诱惑";
    public int index = 0;
    SpUtils spUtils;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_temptation, container, false);
                ...
                retrofitHelper.getImages(map)
                        ...
                        .subscribe(new Subscriber<List<ImagesBean>>() {
                            ...
                            public void onNext(List<ImagesBean> bean) {
                                ...
                                spUtils.put(Constant.TEMPTATION, str);
    ...
    private void initData() {
        ...
        if (spUtils.getSharedPreference(Constant.TEMPTATION, ImagesBean.class) == null) {
            Map<String, String> map = new HashMap<>();
            //map.put("num","10");
            map.put("key", Category);
            map.put("start", "" + index);
            ...
            index+=50;
            String jsonList = (String) spUtils.getSharedPreference(Constant.TEMPTATION, String.class);
            Gson gson1 = new Gson();
